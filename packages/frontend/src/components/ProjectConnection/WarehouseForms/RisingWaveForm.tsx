...
export const RisingWaveSchemaInput: FC<{
    disabled: boolean;
}> = ({ disabled }) => {
...
const RisingWaveForm: FC<{
    disabled: boolean;
}> = ({ disabled }) => {
    const [isOpen, toggleOpen] = useToggle(false);
    const { savedProject } = useProjectFormContext();
    const requireSecrets: boolean =
        savedProject?.warehouseConnection?.type !== WarehouseTypes.RISINGWAVE;
                ...
                <FormSection isOpen={isOpen} name="advanced">
                    <Stack style={{ marginTop: '8px' }}>
                        ...
                        <TextInput
                            ...
                            description={
                                <p>
                                    This controls the RisingWave "search path".
                                    You can see more details in{' '}
                                    <Anchor
                                        target="_blank"
                                ...
                                <Select
                                    ...
                                    description={
                                        <p>
                                            ...
                                            RisingWave databases using SSL. You
